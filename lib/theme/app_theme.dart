...
class AppTheme {
  static ThemeData get dark {
    ...
    return base.copyWith(
      ...
      textTheme: GoogleFonts.soraTextTheme(base.textTheme).apply(
        ...
        bodyMedium: GoogleFonts.sora(fontSize: 13, color: AppColors.white),
        bodySmall: GoogleFonts.sora(fontSize: 11, color: AppColors.muted),
      ),
    );
  }
  ...
  static TextStyle serif({
    ...
    return GoogleFonts.notoSerif(fontSize: size, fontWeight: weight, color: color);
  }
}